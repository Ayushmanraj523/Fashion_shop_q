...
const Home = ({ addToCart, categoryFilter, setCategoryFilter, isLoggedIn, setShowLoginModal, searchQuery, setSearchQuery, sortBy, setSortBy, priceRange, setPriceRange, selectedBrands, setSelectedBrands, ratingFilter, setRatingFilter }) => {
  ...
  console.log('Home - Filter state:', { sortBy, priceRange, selectedBrands, ratingFilter });
  console.log('Home - Filtered products count:', trendingProducts.length);
